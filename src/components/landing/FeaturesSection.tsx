        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {FEATURES.map(({ icon: Icon, title, desc }, i) => (
            <FadeIn key={title} delay={i * 65}>
              <div className="bg-[#FDFAF5] border border-[#E7E0D5] rounded-[20px] p-6 h-full group cursor-default hover:shadow-[0_0_0_1.5px_#2563EB,0_0_24px_rgba(37,99,235,0.08)] transition-all duration-200">
                <div className="w-10 h-10 rounded-[10px] bg-[#EFF6FF] flex items-center justify-center mb-4 group-hover:bg-[#DBEAFE] transition-colors duration-200">
